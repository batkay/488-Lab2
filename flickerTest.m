...
vidWidth = 1440;
vidHeight = 1080;   
vidFPS = 45;        % frame rate for video
bitDepth = 6;
...
for i = 1:100
    ...
    testImg = uint8(round(255)*imresize(redFrame,[vidHeight vidWidth],"nearest"));
    v.writeVideo(testImg);
    testImg = uint8(round(255)*imresize(blackFrame,[vidHeight vidWidth],"nearest"));
    v.writeVideo(testImg);
